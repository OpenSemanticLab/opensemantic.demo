...
Welcome to `opensemantic.demo` contributor's guide.
...
If you experience bugs or general issues with `opensemantic.demo`, please have a look
...
You can help improve `opensemantic.demo` docs by making them more readable and coherent, or
by adding missing information and correcting mistakes.

`opensemantic.demo` documentation uses [Sphinx] as its main documentation compiler.
...
```{todo} If your project is hosted on GitHub, you can also mention the following tip:
   ...
   :::{tip}
      ...
      propose changes in `opensemantic.demo`'s files. While this mechanism can
...
```
conda create -n opensemantic.demo python=3 six virtualenv pytest pytest-cov
conda activate opensemantic.demo
```
...
3. Clone this copy to your local disk:
   ...
   ```
   git clone git@github.com:YourLogin/opensemantic.demo.git
   cd opensemantic.demo
   ```
...
5. Install [pre-commit]:
   ...
   `opensemantic.demo` comes with a lot of hooks configured to automatically help the
...
[repository]: https://github.com/<USERNAME>/opensemantic.demo
[issue tracker]: https://github.com/<USERNAME>/opensemantic.demo/issues
